        ...
        <div class="bend niceties preview-1">
            <div id="ensign-nivoslider-3" class="slides">
                @foreach($sliderImage as $image)
                    <img src="{{ asset($image->image) }}" alt="slider" title="#slider-direction-1"/>
                @endforeach
            ...
            <div id="slider-direction-1" class="t-cn slider-direction">
                <div class="slider-content s-tb slide-1">
                    <div class="title-container s-tb-c">
                        <h1 class="title1">Delicious Shawarma</h1>
...
{{--            </div>--}}
    ...
    <div class="about1-area section-space">
        <img class="img-responsive section-back" src="{{ asset('assets/img/section-back-1.png') }}" alt="Sestion Back">
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-5 col-sm-6 col-xs-12 wow fadeInLeft">
                    <a href="#"><img class="img-responsive" src="{{ asset('assets/img/chef/1.png') }}" alt="chef"></a>
                </div>
            ...
            <div class="row">
                <div class="rc-carousel"
                    ...
                    <div class="special-dish-box">
                        <span>$20</span>
                        <a href="#"><img class="img-responsive" src="{{ asset('assets/img/dish/1.png') }}" alt="dish"></a>
                            ...
                            <li>
                                <div class="media">
                                    <a href="#" class="pull-left">
                                        <img src="{{ asset('assets/img/dish/2.png') }}" alt="client" class="img-responsive">
                                    </a>
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
                            <div class="recipe-of-the-day-content">
                                <div class="recipe-of-the-day-img">
                                    <a href="#"><img class="img-responsive" src="{{ asset('assets/img/recipe-of-the-day-banner.jpg') }}" alt="recipe-of-the-day"></a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="expert-chefs-area">
        <img class="img-responsive section-back" src="{{ asset('assets/img/team/section-back.png') }}" alt="Sestion Back">
        <div class="container">
            ...
            <div class="rc-carousel"
                ...
                <div class="expert-chefs-box">
                    <a href="#"><img class="img-responsive" src={{ asset('assets/img/team/1.jpg') }} alt="team"></a>
                ...
                <div class="expert-chefs-box">
                    <a href="#"><img class="img-responsive" src={{ asset('assets/img/team/2.jpg') }} alt="team"></a>
                    <div class="expert-chefs-box-content">
                        <span></span>
                ...
                <div class="expert-chefs-box">
                    <a href="#"><img class="img-responsive" src="{{ asset('assets/img/team/3.jpg') }}" alt="team"></a>
                    <div class="expert-chefs-box-content">
                        <span></span>
            ...
            <div class="row products-container">
                <div class="col-lg-6 col-md-6 col-sm-7 col-xs-12">
                    <div class="client-reviews-left">
                        <img class="img-responsive" src="{{ asset('assets/img/client/left-back.jpg') }}" alt="client">
                    </div>
                </div>
                        ...
                        <div class="rc-carousel"
                            ...
                            <ul>
                                <li>
                                    <div class="media">
                                        <a href="#" class="pull-left">
                                            <img src="{{ asset('assets/img/client/1.png') }}" alt="client" class="img-responsive">
                                        </a>
                                        <div class="media-body">
                                ...
                                <li>
                                    <div class="media">
                                        <a href="#" class="pull-left">
                                            <img src="{{ asset('assets/img/client/2.png') }}" alt="client" class="img-responsive">
                                        </a>
                                        <div class="media-body">
                                            <h3><a href="#">Daina Rose</a></h3>
                                            <p>Atetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                            ...
                            <ul>
                                ...
                                <li>
                                    <div class="media">
                                        <a href="#" class="pull-left">
                                            <img src="{{ asset('assets/img/client/3.png') }}" alt="client" class="img-responsive">
                                        </a>
                                        <div class="media-body">
                                            <h3><a href="#">Daina Rose</a></h3>
                                            <p>Atetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
    ...
    <div class="brand-area">
        <img class="img-responsive section-back" src="{{ asset('assets/img/brand/back-logo.png') }}" alt="back-logo">
        <div class="container">
            <div class="rc-carousel"
                 data-loop="true"
                 data-items="6"
                ...
                <div class="brand-area-box">
                    <a href="#"><img src="{{ asset('assets/img/brand/1.png') }}" alt="brand"></a>
                </div>
                <div class="brand-area-box">
                    <a href="#"><img src="{{ asset('assets/img/brand/2.png') }}" alt="brand"></a>
                </div>
                <div class="brand-area-box">
                    <a href="#"><img src="{{ asset('assets/img/brand/3.png') }}" alt="brand"></a>
                </div>
                <div class="brand-area-box">
                    <a href="#"><img src="{{ asset('assets/img/brand/4.png') }}" alt="brand"></a>
                </div>
                <div class="brand-area-box">
                    <a href="#"><img src="{{ asset('assets/img/brand/5.png') }}" alt="brand"></a>
                </div>
                <div class="brand-area-box">
                    <a href="#"><img src="{{ asset('assets/img/brand/6.png') }}" alt="brand"></a>
                </div>
                <div class="brand-area-box">
                    <a href="#"><img src="{{ asset('assets/img/brand/7.png') }}" alt="brand"></a>
                </div>
                <div class="brand-area-box">
                    <a href="#"><img src="{{ asset('assets/img/brand/8.png') }}" alt="brand"></a>
                </div>
                <div class="brand-area-box">
                    <a href="#"><img src="{{ asset('assets/img/brand/9.png') }}" alt="brand"></a>
                </div>
                <div class="brand-area-box">
                    <a href="#"><img src="{{ asset('assets/img/brand/10.png') }}" alt="brand"></a>
                </div>
                <div class="brand-area-box">
                    <a href="#"><img src="{{ asset('assets/img/brand/1.png') }}" alt="brand"></a>
                </div>
