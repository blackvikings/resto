...
<!-- Mirrored from radiustheme.com/demo/html/redchili/redchili/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 15 Jun 2021 11:39:33 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <!-- Switch Style CSS -->
    <link rel="stylesheet" href="{{ asset('assets/css/switch-style.css') }}">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                            <div class="logo-area">
                                <a href="index.html"><P><font size="8"><font color="white">LaFiesta Catering</font></font></P></a>
...
{{--                                        </li>--}}
    ...
    <footer>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="footer-box">
                            ...
                            <div class="footer-blog-post">
                                <div class="media">
                                    <a href="#" class="pull-left">
                                        <img src="{{ asset('assets/img/footer-blog1.jpg') }}" alt="footer-blog" class="img-responsive">
                                    </a>
                            ...
                            <div class="footer-blog-post">
                                <div class="media">
                                    <a href="#" class="pull-left">
                                        <img src="{{ asset('assets/img/footer-blog2.jpg') }}" alt="footer-blog" class="img-responsive">
                                    </a>
                                    <div class="media-body">
                                        <h4><a href="#">Beef Burger Daily Special Foods That</a></h4>
                                        <p>20 Aug, 2016</p>
                            ...
                            <div class="footer-blog-post">
                                <div class="media">
                                    <a href="#" class="pull-left">
                                        <img src="{{ asset('assets/img/footer-blog3.jpg') }}" alt="footer-blog" class="img-responsive">
                                    </a>
                                    <div class="media-body">
                                        <h4><a href="#">Beef Burger Daily Special Foods That</a></h4>
                                        <p>20 Aug, 2016</p>
        ...
        <div class="footer-area-bottom">
            <div class="container">
                <p>&copy; 2021 Techplex All Rights Reserved. &nbsp; Designed by<a target="_blank" href="https://techplex.info/" rel="nofollow"> ArchesTech(Techplex)</a></p>
            </div>
        </div>
    </footer>
...
<!-- Switch js -->
<script src="{{ asset('assets/js/switch-style.js') }}" type="text/javascript"></script>
...
<!-- Mirrored from radiustheme.com/demo/html/redchili/redchili/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 15 Jun 2021 11:40:02 GMT -->
</html>
